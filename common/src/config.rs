...
impl Loader {
    ...
    pub fn new(program_name: &str) -> Result<Self, Error> {
        use Error::*;
    ...
    pub fn new_with_dir(program_name: &str, config_dir: &Path) -> Result<Self, Error> {
    ...
    pub fn load_named<T: DeserializeOwned>(&self, name: &str) -> Result<T, Error> {
        use Error::*;
    ...
    pub fn load_or_create<T: DeserializeOwned>(&self, default: &str) -> Result<T, Error> {
